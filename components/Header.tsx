    ...
    <Link href={href}>
      <a
        className={cn(
          ...
          'mr-2 hidden px-3 py-1 text-2xl font-normal lowercase text-dark transition-all duration-200 ease-in-out hover:bg-dark  hover:text-light dark:hover:bg-light dark:hover:text-dark md:inline-block',
        )}
      >
        {text}
      </a>
